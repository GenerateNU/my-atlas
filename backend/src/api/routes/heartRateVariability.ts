...
*/
  ...
  route.get('/getHeartRateAverage/:id/', async (req: Request, res: Response, next: NextFunction) => {
    const logger: Logger = Container.get('logger');
  ...
  route.get('/getHeartRateVariabilityByID/:id/', async (req: Request, res: Response, next: NextFunction) => {
    const logger: Logger = Container.get('logger');
  ...
  route.delete('/deleteHeartRateVariabilityByID/:id', async (req: Request, res: Response, next: NextFunction) => {
    const logger: Logger = Container.get('logger');
